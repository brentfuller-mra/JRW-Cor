...
Used for identifying the relative impact/influence of different drivers of an outcome (e.g., overall satisfaction) even when independent variables are highly collinear.
